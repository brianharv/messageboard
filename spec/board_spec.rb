...
describe('#Board') do
  ...
  describe('.all') do
    it('displays all Boards') do
      board = Board.new({:title => 'Thoughts', :id => nil, :description => nil})
      board.save()
      board2 = Board.new({:title => 'Robots', :id => nil, :description => nil})
      board2.save()
  ...
  describe('#==') do
    it('Is the same board if it has the same name') do
      board = Board.new({:title => 'Thoughts', :id => nil, :description => nil})
      board.save()
      board2 = Board.new({:title => 'Thoughts', :id => nil, :description => nil})
      board2.save()
  ...
  describe('.sort_board_by_name') do
    it('sorts boards alphabetically') do
      ...
      board2 = Board.new({:title => 'Robots', :id => nil, :description => nil})
      board2.save()
      board3 = Board.new({:title => 'Warm Cots', :id => nil, :description => nil})
      board3.save()
